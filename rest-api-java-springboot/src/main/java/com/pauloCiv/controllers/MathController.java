...
import com.pauloCiv.math.SimpleMath;
import com.pauloCiv.request.converters.NumberConverter;
...
public class MathController {
    ...
    public Double squareRoot(
        ...
        if(!NumberConverter.isNumeric(number) || NumberConverter.convertToDouble(number) < 0) throw new UnsupportedMathOperationException("Please set a numeric and positive value!");
